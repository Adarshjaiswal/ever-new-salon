<header>
			<div class="container">
				<div class="header-bottom-agileits">
					<div class="w3-logo">
						<h5><a href="index.html">EverNew Beauty Salon</a></h5>
					</div>
					<div class="address">
						<p>St. No: 3, Harban Nagar, Near ITI Bhatinda(PB)</p>
						<p class="para-y"><a href="about.html">Get more info</a></p>
					</div>
					<div class="nav-contact-w3ls">
						<p>+91 9876608195<span class="fa fa-phone" aria-hidden="true"></span></p>
